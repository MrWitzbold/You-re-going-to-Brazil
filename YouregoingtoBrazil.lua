...
local anthem = Instance.new("TextButton")
...
main.BackgroundColor3 = Color3.fromRGB(0, 151, 56)
main.BorderColor3 = Color3.fromRGB(242, 217, 0)
main.BorderSizePixel = 5
main.Position = UDim2.new(0.360824764, 0, 0.157370523, 0)
main.Size = UDim2.new(0, 309, 0, 383)

line.Name = "line"
line.Parent = main
line.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
line.BorderSizePixel = 0
line.Position = UDim2.new(0.00323624606, 0, 0.932114899, 0)
line.Size = UDim2.new(0, 308, 0, 6)
...
discord.Position = UDim2.new(0, 0, 0.947780669, 0)
discord.Size = UDim2.new(0, 134, 0, 20)
discord.Font = Enum.Font.SourceSans
discord.Text = "Discord: 86UuVXQ"
...
TextLabel.Position = UDim2.new(0.741100311, 0, 0.947780669, 0)
...
ImageLabel.Position = UDim2.new(0.585760534, 0, 0.563968658, 0)
ImageLabel.Size = UDim2.new(0, 128, 0, 141)
ImageLabel.Image = "http://www.roblox.com/asset/?id=5577430049"

title.Name = "title"
title.Parent = main
title.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
title.BorderSizePixel = 0
title.Size = UDim2.new(0, 308, 0, 50)
title.Font = Enum.Font.SourceSans
title.Text = "You're going to Brazil"
title.TextColor3 = Color3.fromRGB(255, 255, 255)
title.TextSize = 35.000

xray.Name = "xray"
xray.Parent = main
xray.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
xray.BorderColor3 = Color3.fromRGB(0, 17, 53)
xray.BorderSizePixel = 4
xray.Position = UDim2.new(0.0226537213, 0, 0.148825064, 0)
xray.Size = UDim2.new(0, 133, 0, 50)
xray.Font = Enum.Font.SourceSans
xray.Text = "X-ray transparent blox"
xray.TextColor3 = Color3.fromRGB(255, 255, 255)
xray.TextSize = 15.000

Admin.Name = "Admin"
Admin.Parent = main
Admin.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
Admin.BorderColor3 = Color3.fromRGB(0, 17, 53)
Admin.BorderSizePixel = 4
Admin.Position = UDim2.new(0.556634307, 0, 0.148825064, 0)
Admin.Size = UDim2.new(0, 133, 0, 50)
...
chill.Name = "chill"
chill.Parent = main
chill.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
chill.BorderColor3 = Color3.fromRGB(0, 17, 53)
chill.BorderSizePixel = 4
chill.Position = UDim2.new(0.0226536989, 0, 0.308093995, 0)
chill.Size = UDim2.new(0, 133, 0, 50)
chill.Font = Enum.Font.SourceSans
chill.Text = "FE Chill"
chill.TextColor3 = Color3.fromRGB(255, 255, 255)
chill.TextSize = 15.000

flag.Name = "flag"
flag.Parent = main
flag.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
flag.BorderColor3 = Color3.fromRGB(0, 17, 53)
flag.BorderSizePixel = 4
flag.Position = UDim2.new(0.556634307, 0, 0.308093995, 0)
flag.Size = UDim2.new(0, 133, 0, 50)
flag.Font = Enum.Font.SourceSans
flag.Text = "Flag spam"
flag.TextColor3 = Color3.fromRGB(255, 255, 255)
flag.TextSize = 15.000

anthem.Name = "anthem"
anthem.Parent = main
anthem.BackgroundColor3 = Color3.fromRGB(0, 38, 115)
anthem.BorderColor3 = Color3.fromRGB(0, 17, 53)
anthem.BorderSizePixel = 4
anthem.Position = UDim2.new(0.0226537213, 0, 0.46736297, 0)
anthem.Size = UDim2.new(0, 133, 0, 50)
anthem.Font = Enum.Font.SourceSans
anthem.Text = "Chant anthem in chat"
anthem.TextColor3 = Color3.fromRGB(255, 255, 255)
anthem.TextSize = 15.000

Open.Name = "Open"
Open.Parent = ScreenGui
Open.BackgroundColor3 = Color3.fromRGB(0, 151, 56)
Open.BorderColor3 = Color3.fromRGB(247, 217, 0)
Open.BorderSizePixel = 5
Open.Position = UDim2.new(0.40487349, 0, 0.0199203193, 0)
Open.Size = UDim2.new(0, 77, 0, 50)
...
Close.BackgroundColor3 = Color3.fromRGB(0, 151, 56)
Close.BorderColor3 = Color3.fromRGB(247, 217, 0)
Close.BorderSizePixel = 5
Close.Position = UDim2.new(0.522024393, 0, 0.0199203193, 0)
...
local function PUFXPAD_fake_script() -- xray.LocalScript 
...
coroutine.wrap(PUFXPAD_fake_script)()
local function DULUAKG_fake_script() -- Admin.LocalScript 
...
coroutine.wrap(DULUAKG_fake_script)()
local function ZLIJV_fake_script() -- chill.LocalScript 
...
coroutine.wrap(ZLIJV_fake_script)()
local function TXHFRTH_fake_script() -- flag.LocalScript 
	local script = Instance.new('LocalScript', flag)
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i,v in pairs(workspace:GetChildren()) do
			if v:IsA("Part") then
					...
					decal1.Parent = v
					decal1.Texture = "rbxassetid://642204237"
					decal1.Face = "Front"
					
					decal2 = Instance.new("Decal")
					decal2.Parent = v
					decal2.Texture = "rbxassetid://642204237"
					decal2.Face = "Back"
					
					decal3 = Instance.new("Decal")
					decal3.Parent = v
					decal3.Texture = "rbxassetid://642204237"
					decal3.Face = "Left"
					
					decal4 = Instance.new("Decal")
					decal4.Parent = v
					decal4.Texture = "rbxassetid://642204237"
					decal4.Face = "Right"
					
					decal5 = Instance.new("Decal")
					decal5.Parent = v
					decal5.Texture = "rbxassetid://642204237"
					decal5.Face = "Top"
					
					decal6 = Instance.new("Decal")
					decal6.Parent = v
					decal6.Texture = "rbxassetid://642204237"
					decal6.Face = "Bottom"
			end
		end
	end)
end
coroutine.wrap(TXHFRTH_fake_script)()
local function YOKQT_fake_script() -- anthem.LocalScript 
	local script = Instance.new('LocalScript', anthem)

	script.Parent.MouseButton1Click:Connect(function()
		
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("The placid shores of the Ipiranga river heard,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("the resounding shout of a heroic folk", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("And the sun of Liberty in shining beams", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("shone in the homeland's sky at that instant", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("If the pledge of this equality", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("we managed to conquer with strong arm", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("In thy bosom, O Freedom,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("our chest defies death itself!", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("O beloved,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("idolized homeland,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Hail, hail!", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Brazil, an intense dream, a vivid ray", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("of love and hope descends to earth", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("If in thy beautiful, smiling and limpid sky", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("the image of the (Southern) Cross blazes.", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Giant by thine own nature", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Thou art beautiful, strong, a fearless colossus", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("And thy future mirrors that greatness", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Adored Land", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Amongst thousand others", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("art thou, Brazil,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("O beloved homeland", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Of the sons of this ground", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Thou art kind mother", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Beloved homeland, Brazil", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Eternally lying on splendid cradle", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("to the sound of sea and under deep sky light", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Thou flashest, Brazil, crocket of America,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("illuminated by the sun of New World", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Than the more garish land,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("thy smiling, pretty prairies have more flowers", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Our groves have more life", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Our life in thy bosom more loves", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("O beloved,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("idolized homeland,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("hail, hail!", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Brazil, of eternal love be a symbol", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("the starred labarum which thou displayst", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("And say the laurel-green of this pennant", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Peace in the future and glory in the past", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("But if thou raisest the strong mace of justice,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("thou wilt see that a son of thine flees not from battle,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("nor do those who love thee fear their own death", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Adored Land", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Amongst thousand others", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("art thou, Brazil,", "All") wait(3)
	game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("O beloved homeland", "All") wait(3)
...
coroutine.wrap(YOKQT_fake_script)()
local function JNCT_fake_script() -- Open.LocalScript 
...
coroutine.wrap(JNCT_fake_script)()
local function LLEREC_fake_script() -- Close.LocalScript 
...
coroutine.wrap(LLEREC_fake_script)()
